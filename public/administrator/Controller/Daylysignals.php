...
use Model\DaylySignals as Model;
...
class DaylySignals extends BaseController{
    protected $headerUrl = "daylysignals/add/";
    private $rr;
    private $rrr;
    ...
    public function __construct($route,$countRoute)
    {
        ...
        $this->result = array("url"=>"daylysignals", 'controller'=>'tips', "table"=>"tips");
    ...
    private function itemView($id)
    {
            ...
            $this->renderView("Pages/dayly_signals","tips",$this->result);
    }
