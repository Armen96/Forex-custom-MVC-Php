        ...
        <div class='table_head'>
            <div class="form_input">
                <div class="input_group add_project">
                    ...
                    <a href='<?= $baseurl ?>/<?= $page ?>/add/' class='save'>Add Product</a>
                </div>
            </div>
        </div>
        <table>
                ...
                if (isset($params['result'])) {
                    foreach ($params['result'] as $val) {
                        ...
                        <tr id='m_<?= $val['id'] ?>'>
                            ...
                            <td>
                                <a href='<?= $baseurl ?>/<?= $params['url'] ?>/add/<?= $val['id'] ?>/'><span><?= $val['name_ru'] ?></span></a>
                            </td>
                            <td>
                                <span><?php if($val['cid']==1){?>
                                advaisors
                                <?php }elseif($val['cid']==2){?>
                                indicators
                                <?php }elseif($val['cid']==4){?>
                                dayly_signals
                                <?php }elseif($val['cid']==5){?>
                                sport_tips
                            <?php }?>
                                </span>
                            </td>
