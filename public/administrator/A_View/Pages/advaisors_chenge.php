<div id='content'>
    <form id='main_form' action='<?=$baseurl?>/advaisors/aa/1/' method='post' enctype="multipart/form-data">
        ...
        <div class='box'>
            ...
            <div class="box_edit box_ck">
                ...
                <div>
                    <textarea name="text_ru" id="text_b"><?= isset($params['result']['text_ru']) ? $params['result']['text_ru'] : '' ?></textarea>
                    <script type="text/javascript">
                        CKEDITOR.replace('text_b');
                    </script>
                </div>
                <div class="clear"></div>
            </div>
