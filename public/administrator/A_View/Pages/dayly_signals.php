<div id='content'>
    <form id='main_form' action='<?=$baseurl?>/daylysignals/aa/4/' method='post' enctype="multipart/form-data">
        ...
        <div class='box'>
            ...
            <div class="box_edit box_ck">
                ...
                <div>
                    <textarea name="text_ru" id="text_c"><?= isset($params['result']['text_ru']) ? $params['result']['text_ru'] : '' ?></textarea>
                    <script type="text/javascript">
                        CKEDITOR.replace('text_c');
                    </script>
                </div>
                <div class="clear"></div>
            </div>
